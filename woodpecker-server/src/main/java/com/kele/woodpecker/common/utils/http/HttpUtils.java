...
public class HttpUtils
{
    ...
    public static String doHttpReq(String method,String url, String token, String jsonStr){
        switch (method){
            case "GET":
                return doGet(url,token);
            case "POST":
                return doPost(url,token,jsonStr);
            case "PUT":
                return doPut(url,token,jsonStr);
            case "DELETE":
                return doDelete(url,token,jsonStr);
            default:
                return null;
        }
